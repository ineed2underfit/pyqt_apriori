...
class Ui_page_two(object):
    def setupUi(self, page_two):
        ...
        self.doubleSpinBox_new = QDoubleSpinBox(page_two)
        self.doubleSpinBox_new.setObjectName(u"doubleSpinBox_new")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.doubleSpinBox_new.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_new.setSizePolicy(sizePolicy)
        self.doubleSpinBox_new.setMaximum(1.000000000000000)
        self.doubleSpinBox_new.setSingleStep(0.100000000000000)
        self.doubleSpinBox_new.setValue(0.300000000000000)

        self.gridLayout.addWidget(self.doubleSpinBox_new, 5, 1, 1, 1)

        self.label_new = QLabel(page_two)
        self.label_new.setObjectName(u"label_new")

        self.gridLayout.addWidget(self.label_new, 4, 1, 1, 1)
        ...
        sizePolicy.setHeightForWidth(self.doubleSpinBox_confidence.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_confidence.setSizePolicy(sizePolicy)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_confidence, 5, 0, 1, 1)

        self.label_confidence = QLabel(page_two)
        self.label_confidence.setObjectName(u"label_confidence")

        self.gridLayout.addWidget(self.label_confidence, 4, 0, 1, 1)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_2, 0, 3, 9, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_support, 2, 0, 1, 1)

        self.label_lift = QLabel(page_two)
        self.label_lift.setObjectName(u"label_lift")
        sizePolicy.setHeightForWidth(self.label_lift.sizePolicy().hasHeightForWidth())
        self.label_lift.setSizePolicy(sizePolicy)

        self.gridLayout.addWidget(self.label_lift, 6, 0, 1, 1)

        self.doubleSpinBox_lift = QDoubleSpinBox(page_two)
        self.doubleSpinBox_lift.setObjectName(u"doubleSpinBox_lift")
        sizePolicy.setHeightForWidth(self.doubleSpinBox_lift.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_lift.setSizePolicy(sizePolicy)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_lift, 7, 0, 1, 1)

        self.doubleSpinBox_binning = QDoubleSpinBox(page_two)
        self.doubleSpinBox_binning.setObjectName(u"doubleSpinBox_binning")
        sizePolicy.setHeightForWidth(self.doubleSpinBox_binning.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_binning.setSizePolicy(sizePolicy)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_binning, 2, 1, 1, 1)

        self.label_support = QLabel(page_two)
        self.label_support.setObjectName(u"label_support")

        self.gridLayout.addWidget(self.label_support, 1, 0, 1, 1)

        self.label_binning = QLabel(page_two)
        self.label_binning.setObjectName(u"label_binning")

        self.gridLayout.addWidget(self.label_binning, 1, 1, 1, 1)
    ...
    def retranslateUi(self, page_two):
        ...
        self.label_new.setText(QCoreApplication.translate("page_two", u"\u6700\u5c0f\u652f\u6301\u5ea6", None))
        ...
        self.label_support.setText(QCoreApplication.translate("page_two", u"\u6700\u5c0f\u6574\u4f53\u652f\u6301\u5ea6", None))
