...
# 创建输出目录
os.makedirs('dataset/testdata_info', exist_ok=True)
...
# 保存数据
dataset.to_csv('dataset/testdata_info/training_dataset.csv', index=False)
...
plt.tight_layout()
plt.savefig('dataset/testdata_info/故障分布柱状图.png')
plt.show()